...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-09-2018 a las 22:58:59
...
(6, 'TIPO_PUBLICACION', 'Tipo de publicacion');
...
CREATE TABLE `publicacion` (
  ...
  `publicacion` varchar(1000) CHARACTER SET utf8 COLLATE utf8_spanish2_ci NOT NULL,
  `fechaInicio` datetime NOT NULL,
  `fechaFin` datetime NOT NULL,
...
ALTER TABLE `contrato`
  ...
  ADD KEY `contrato_ibfk_1` (`idPropietario`),
  ADD KEY `contrato_ibfk_2` (`idOcupante`),
  ADD KEY `contrato_ibfk_3` (`idVehiculo`);
...
ALTER TABLE `relaciones`
  ...
  ADD KEY `idUsuarioPropietario` (`idUsuario2`);
...
--
ALTER TABLE `datamaster`
  MODIFY `idDataMaster` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de la tabla `datatype`
--
ALTER TABLE `datatype`
  MODIFY `idDataType` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `contrato`
  ADD CONSTRAINT `contrato_ibfk_1` FOREIGN KEY (`idPropietario`) REFERENCES `usuario` (`idUsuario`),
  ADD CONSTRAINT `contrato_ibfk_2` FOREIGN KEY (`idOcupante`) REFERENCES `usuario` (`idUsuario`),
  ADD CONSTRAINT `contrato_ibfk_3` FOREIGN KEY (`idVehiculo`) REFERENCES `vehiculo` (`idVehiculo`);
...
--
ALTER TABLE `relaciones`
  ADD CONSTRAINT `relaciones_ibfk_1` FOREIGN KEY (`idUsuario1`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `relaciones_ibfk_2` FOREIGN KEY (`idUsuario2`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
